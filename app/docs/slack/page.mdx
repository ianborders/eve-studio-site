...
In Studio, go to **Integrations → Channels → the Slack card → Set up**. It's a 5-step wizard. (If you'd rather drive it from the registry, `eve add channel/slack` installs the same channel and runs Eve's own setup flow.)
