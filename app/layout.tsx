...
const description =
  "A native desktop app to run, chat with, build, wire up, and deploy every Eve agent on your Mac, with no terminal, ever. An independent open-source project; not an official Vercel product.";
